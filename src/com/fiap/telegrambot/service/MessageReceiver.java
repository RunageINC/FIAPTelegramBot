...
import com.fiap.telegrambot.util.Parser;
import com.fiap.telegrambot.util.handler.AbstractHandler;
import com.fiap.telegrambot.util.handler.CepHandler;
import com.fiap.telegrambot.util.handler.DefaultHandler;
import com.fiap.telegrambot.util.handler.EmojiHandler;
import com.fiap.telegrambot.util.handler.NotifyHandler;
import com.fiap.telegrambot.util.handler.SystemHandler;
...
public class MessageReceiver implements Runnable {
	...
	public MessageReceiver(TelegramBotCore bot) {
		this.bot = bot;
	...
	private void analyzeForUpdateType(Update update) {
		...
		if (!"".equals(operationResult)) {
			...
			messageOut.setChatId(Long.toString(chatId));
	...
	private AbstractHandler getHandlerForCommand(Command command) {
		...
		case TEXT_CONTAIN_EMOJI:
			...
			return emojiHandler;
		case CEP:
			CepHandler cepHandler = new CepHandler(bot);
			log.info("Handler for command[" + command.toString() + "] is: " + cepHandler);
			return cepHandler;
		default:
